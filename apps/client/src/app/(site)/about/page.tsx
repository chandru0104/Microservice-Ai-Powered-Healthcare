...
const About = () => {
    return (
        <div>
            ...
            <p className="pb-4">Care Hub offers a comprehensive ecosystem of healthcare services. From instant online doctor consultations and at-home diagnostic tests to seamless home delivery of medicines, we ensure that every aspect of your health is covered under one roof.</p>
            <p className="font-semibold">Our Vision</p>
            <p className="pb-4">To touch a billion lives by bringing healthcare of international standards within reach of every individual, combining clinical excellence with advanced AI technology and compassionate care.</p>
            <p className="font-semibold">Our Mission</p>
            <p className="pb-4">To provide accessible, high-quality, affordable, and personalized digital healthcare services—including doctor consultations, diagnostic tests, and pharmacy delivery—empowering individuals to lead healthier lives.</p>
