        ...
        <div>
            ...
            <Grid container spacing={0}>
                <Grid size={2} className="h-screen flex flex-col">
                    ...
                    <div className="flex gap-2 items-center justify-center m-4 bg-gray-100 text-gray-900 p-2 rounded-md cursor-pointer mt-auto shrink-0">
                        <LuLogOut /> <button onClick={logout}>Logout</button>
                    </div>
                </Grid>
                <Grid size={10}>
